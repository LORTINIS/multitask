...
This script trains a single SNN with shared layers to perform both:
1. Wine quality classification (HQ, LQ, AQ)
2. Ethanol concentration regression (1-20%)

The network architecture matches Figure 17 with shared processing layers
followed by task-specific branches.
"""
...
def main(selected_arch_name=None):
    ...
    print("TWO SHARED LAYERS ARCHITECTURE")
    print("="*80)
